          ...
          <div className='ml-[40px] w-[40%] max-md:w-full max-md:ml-0 '>
            ...
            <div>
              ...
              <div>
                ...
                <p className='mb-2 text-[#000] text-[1rem] list-item'>
                ...
                <p className='text-[#000] text-[1rem] list-item'>
                  PU4, 3rd Floor, Sky Space, Behind Malhar Mega Mall, Vijay
                  Nagar, Indore, Madhya Pradesh – 452001
                </p>
                <p className='text-[#000] text-[1rem] list-item'>
                  601/602, 6th Floor, Balaji Business Park, Andheri - Kurla Rd.
                  Gamdevi, Marol Naka, Andheri East, Mumbai, Maharashtra -
                  400059
                </p>
              </div>
            </div>
